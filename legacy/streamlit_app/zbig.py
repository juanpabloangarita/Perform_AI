            ...
            with st.container():
                ...
                if not day_data.empty:
                    ...
                    for idx, row in day_data.iterrows():
                        ...
                        if today_highlight[i]:
                            container_style = "background-color:#f0f8ff; padding: 8px; border-radius:10px; font-size:14px; border: 1px solid #ddd;"
                        else:
                            container_style = "padding: 8px; border-radius:10px; font-size:14px; border: 1px solid #ddd;"

                        with st.container():
                            # Display the workout details with bold tags and adjusted text sizes
                            st.markdown(f"<div style='{container_style}'>"
                                        f"<b style='font-size:16px;'>{workout_type}</b><br>"
